      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div>
                <h3 className="text-2xl font-bold text-white mb-4">Why Choose GenFusionWorks?</h3>
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-purple-400 pl-4">
                    <p className="text-gray-300 text-sm italic mb-2">
                      "GenFusionWorks transformed our outdated website into a modern, high-performing platform that increased our conversions by 250%."
                    </p>
