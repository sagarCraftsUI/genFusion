...
import aboutUsBanner from '../assets/about-us-banner.jpeg';
import ourStory from '../assets/our-story.jpg';

const About = () => {
  const stats = [
    { icon: Users, number: '48+', label: 'Happy Clients' },
    { icon: Award, number: '128+', label: 'Projects Completed' },
    { icon: Clock, number: '12+', label: 'Years Experience' },
  ...
  const team = [
    {
      ...
      description: 'With 10+ years in tech leadership, Sahil drives our vision of transforming businesses through technology.'
    },
    {
      name: 'Sarah Chen',
      role: 'CTO',
  ...
  const milestones = [
    {
      ...
      description: 'Started GenFusionWorks with a vision to transform businesses through technology.'
    },
    {
      year: '2020',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-300 text-lg mb-6 leading-relaxed">
                GenFusionWorks was born from a simple yet powerful vision: to bridge the gap between innovative technology and business success. Founded in 2019, we started as a small team of passionate developers and designers who believed that every business deserves access to world-class digital solutions.
              </p>
              <p className="text-gray-300 text-lg mb-6 leading-relaxed">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              The talented individuals who make GenFusionWorks a leader in IT solutions.
            </p>
          </motion.div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Join the 150+ satisfied clients who have transformed their businesses with GenFusionWorks.
            </p>
