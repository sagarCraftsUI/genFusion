...
import mobileAppDevelopmentImage from '../assets/mobile-app-development-service.jpeg';
import webDevelopmentImage from '../assets/web-development-services.jpeg';
import uiUxDesignImage from '../assets/ui-ux-design-service.jpeg';
import seoAndDigitalMarketingImage from '../assets/seo-digital-marketing-service.jpeg';
import productDevelopmentServicesImage from '../assets/product-development-services.jpeg';
import itConsultingImage from '../assets/it-consulting-service.jpeg'
import homePageBanner from '../assets/home-page-banner.jpeg';
...
const Home = () => {
  ...
  const stats = [
    { number: '128+', label: 'Projects Completed' },
    { number: '48+', label: 'Happy Clients' },
  ...
  const testimonials = [
    {
      ...
      content: 'GenFusionWorks transformed our vision into a stunning web application. Their attention to detail and technical expertise exceeded our expectations.',
      rating: 5
    },
    {
      name: 'Michael Chen',
